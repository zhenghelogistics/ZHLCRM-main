...
const StatCard: React.FC<{ title: string; value: string; icon: React.ReactNode; color: string }> = ({ title, value, icon, color }) => (
    <div className="bg-white/80 backdrop-blur-md border border-slate-200 rounded-xl p-4 flex items-center space-x-4 shadow-sm">
        <div className={`rounded-full p-3 ${color} text-white shadow-md`}>
            {icon}
        </div>
        <div>
