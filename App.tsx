...
const App: React.FC = () => {
        ...
        if (isAppLoading && currentPage !== 'devtools') {
            return (
                 <div className="flex justify-center items-center h-[80vh] flex-col">
                    <ShipIcon className="h-16 w-16 text-blue-500 animate-pulse" />
                    <div className="flex items-center mt-4">
                        <LoaderIcon className="animate-spin h-8 w-8 text-blue-500" />
                        <span className="ml-4 text-xl text-slate-300">Connecting to Database...</span>
                    </div>
                </div>
            )
        }
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-1 space-y-6">
                            ...
                            {parsedQuote && (
                             ...
                             {error && (
                                <div className="bg-red-900/50 border border-red-700 text-red-300 px-4 py-3 rounded-lg flex items-start space-x-2" role="alert">
                            ...
                            {lastJson && !parsedQuote && (
                                 <div className="bg-zinc-900/40 backdrop-blur-md border border-zinc-800/50 rounded-xl p-4">
                                    <h3 className="text-sm font-semibold text-slate-300 mb-2 flex items-center"><JsonIcon className="h-5 w-5 mr-2 text-slate-400"/>Last Saved Lead</h3>
                                    <pre className="bg-slate-900 p-3 rounded text-xs text-slate-300 overflow-x-auto"><code>{lastJson}</code></pre>
                                </div>
                            )}
                        </div>
    ...
    return (
        <div className="relative min-h-screen bg-[#020203] overflow-hidden">
